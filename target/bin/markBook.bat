...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="markBook" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" main.Main %CMD_LINE_ARGS%
